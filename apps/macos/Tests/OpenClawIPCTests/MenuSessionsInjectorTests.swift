...
struct MenuSessionsInjectorTests {
    ...
    @Test func injectsSessionRows() {
        ...
        let defaults = SessionDefaults(model: "ollama/gpt-oss-120b", contextTokens: 128_000)
        let rows = [
            SessionRow(
                id: "main",
                key: "main",
                ...
                tokens: SessionTokenStats(input: 10, output: 20, total: 30, contextTokens: 128_000),
                model: "gpt-oss-120b"),
            SessionRow(
                ...
                systemSent: true,
                abortedLastRun: true,
                tokens: SessionTokenStats(input: 50, output: 50, total: 100, contextTokens: 128_000),
                model: "gpt-oss-120b"),
        ]
