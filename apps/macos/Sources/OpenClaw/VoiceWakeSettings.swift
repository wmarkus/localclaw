        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading, spacing: 14) {
                SettingsToggleRow(
                    ...
                    subtitle: "Listen for a wake phrase (e.g. \"OpenClaw\") before running voice commands. "
...
extension VoiceWakeSettings {
    static func exerciseForTesting() {
        ...
        state.swabbleTriggerWords = ["OpenClaw", "Hey"]
        ...
        view.isTesting = true
        view.triggerEntries = [TriggerEntry(id: UUID(), value: "OpenClaw")]
