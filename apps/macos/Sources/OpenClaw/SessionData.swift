    ...
    static var previewRows: [SessionRow] {
        [
            SessionRow(
                ...
                tokens: SessionTokenStats(input: 320, output: 680, total: 1000, contextTokens: 128_000),
                model: "gpt-oss-120b"),
            SessionRow(
                id: "group-1",
                ...
                systemSent: true,
                abortedLastRun: true,
                tokens: SessionTokenStats(input: 5000, output: 1200, total: 6200, contextTokens: 128_000),
                model: "gpt-oss-120b"),
            SessionRow(
                id: "global",
                key: "global",
                ...
                systemSent: false,
                abortedLastRun: false,
                tokens: SessionTokenStats(input: 150, output: 220, total: 370, contextTokens: 128_000),
                model: "gpt-oss-120b"),
        ]
    }
}
...
enum SessionLoader {
    ...
    static let fallbackContextTokens = 128_000
