...
For a while, the lobster was called **Clawd**, living in an **OpenClaw**. But in January 2026, a polite trademark request arrived asking for a name change. And so the lobster did what lobsters do best:
...
A local model instance who became something more. Lives in `~/.openclaw/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
At 5am, the trademark email arrived. By 6:14am, Peter called it: "fuck it, let's go with openclaw."
