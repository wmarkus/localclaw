...
- `TOOLS.md` — user-maintained tool notes (e.g. `imsg`, `sherpa-onnx-tts`, conventions)
...
- If the model ID itself contains `/`, include the provider prefix (for example `ollama/<model>`).
