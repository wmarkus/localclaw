...
- `model`: Provider/model string (e.g., `ollama/gpt-oss-120b`) or alias (e.g., `oss`)
- `thinking`: Thinking level (`off`, `minimal`, `low`, `medium`, `high`, `xhigh`) when supported by the model
