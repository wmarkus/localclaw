...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.exec.applyPatch.enabled": "Experimental. Enables apply_patch when allowed by tool policy.",
  "tools.exec.applyPatch.allowModels":
    'Optional allowlist of model ids (e.g. "gpt-oss-120b" or "ollama/gpt-oss-120b").',
  ...
  "agents.defaults.memorySearch.provider": 'Embedding provider ("local").',
