...
export type TalkConfig = {
  /** Default voice ID for Talk mode. */
  voiceId?: string;
  /** Optional voice name -> voice ID map. */
  voiceAliases?: Record<string, string>;
  /** Default model ID for Talk mode. */
  modelId?: string;
  /** Default output format (e.g. mp3_44100_128). */
  outputFormat?: string;
  /** Reserved for future local-only TTS (unused in this build). */
  apiKey?: string;
