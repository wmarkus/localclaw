...
const EMBEDDING_QUERY_TIMEOUT_MS = 5 * 60_000;
const EMBEDDING_BATCH_TIMEOUT_MS = 10 * 60_000;
...
export class MemoryIndexManager implements MemorySearchManager {
  ...
  private readonly requestedProvider: "local";
  ...
  private resolveEmbeddingTimeout(kind: "query" | "batch"): number {
    return kind === "query" ? EMBEDDING_QUERY_TIMEOUT_MS : EMBEDDING_BATCH_TIMEOUT_MS;
  }
