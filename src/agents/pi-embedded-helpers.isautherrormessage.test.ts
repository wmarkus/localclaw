...
describe("isAuthErrorMessage", () => {
  it("matches credential validation errors", () => {
    const samples = [
      'No credentials found for profile "ollama:default".',
      "No API key found for profile ollama.",
    ];
  ...
  it("matches OAuth refresh failures", () => {
    const samples = [
      "OAuth token refresh failed for provider: Failed to refresh OAuth token. Please try again or re-authenticate.",
