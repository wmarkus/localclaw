...
describe("formatAssistantErrorText", () => {
  ...
  it("returns context overflow for 'Request size exceeds model context window'", () => {
    // This error format wasn't being detected.
  ...
  it("returns a friendly message for role ordering", () => {
  ...
  it("returns a friendly message for overload errors", () => {
    const msg = makeAssistantError(
  ...
  it("returns a friendly billing message for credit balance errors", () => {
    const msg = makeAssistantError("Your credit balance is too low to access the model API.");
    const result = formatAssistantErrorText(msg);
