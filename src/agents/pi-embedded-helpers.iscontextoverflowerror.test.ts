...
describe("isContextOverflowError", () => {
  ...
  it("matches 'Request size exceeds model context window' error", () => {
    // Some providers return this error format when the prompt exceeds the context window.
    ...
    expect(isContextOverflowError(rawError)).toBe(true);
  });
