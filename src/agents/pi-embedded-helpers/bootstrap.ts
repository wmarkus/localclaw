...
/**
 * Strips thought_signature fields that are known to be invalid in some runtimes.
 *
 * When `allowBase64Only` is true, only base64-compatible signatures are preserved.
 */
