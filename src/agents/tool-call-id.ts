 ...
 * - "strict9" mode: only [a-zA-Z0-9], length 9
 */
...
export function isValidToolCallId(id: string, mode: ToolCallIdMode = "strict"): boolean {
  if (!id || typeof id !== "string") {
    return false;
  }
  if (mode === "strict9") {
  ...
  // Strictly alphanumeric for tighter tool ID constraints
...
/**
 * Sanitize tool call IDs for compatibility.
 *
