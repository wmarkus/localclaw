...
describe("directive behavior", () => {
  beforeEach(() => {
    ...
    vi.mocked(loadModelCatalog).mockResolvedValue([
      { id: "gpt-oss-120b", name: "Opus 4.5", provider: "ollama" },
      { id: "gpt-oss-120b", name: "Sonnet 4.1", provider: "ollama" },
      { id: "gpt-oss-120b", name: "GPT-4.1 Mini", provider: "ollama" },
    ]);
  });
    ...
    await withTempHome(async (home) => {
      ...
      const res = await getReplyFromConfig(
        ...
        {},
        {
          agents: {
            defaults: {
              model: "ollama/gpt-oss-120b-codex",
  ...
  it("accepts /thinking xhigh for ollama gpt-oss-120b", async () => {
    await withTempHome(async (home) => {
      const storePath = path.join(home, "sessions.json");
  ...
  it("rejects /thinking xhigh for non-codex models", async () => {
    await withTempHome(async (home) => {
      ...
      expect(texts).toContain(
        'Thinking level "xhigh" is only supported for ollama/gpt-oss-120b, ollama/gpt-5.3-codex, ollama/gpt-oss-120b-codex or ollama/gpt-5.1-codex.',
      );
    });
  });
        ...
        {},
        {
          agents: {
            defaults: {
              ...
              workspace: path.join(home, "openclaw"),
              models: {
                "ollama/gpt-oss-120b": { alias: " help " },
              },
            },
          },
          channels: { whatsapp: { allowFrom: ["*"] } },
        ...
        {},
        {
          agents: {
            defaults: {
              ...
              workspace,
              models: {
                "ollama/gpt-oss-120b": { alias: "demo_skill" },
              },
            },
          },
          channels: { whatsapp: { allowFrom: ["*"] } },
