...
export type ResponsePrefixContext = {
  ...
  model?: string;
  /** Full model ID including provider (e.g., "ollama/gpt-oss-120b") */
  modelFull?: string;
 ...
 *   thinkingLevel: "high"
 * })
 * // Returns: "[gpt-oss-120b | think:high]"
 */
 ...
 *
 * Strips:
 * - Provider prefix (e.g., "ollama/" from "ollama/gpt-oss-120b")
 * - Date suffixes (e.g., "-20260205" from "gpt-oss-120b-20260205")
 * - Common version suffixes (e.g., "-latest")
 *
 * @example
 * extractShortModelName("ollama/gpt-oss-120b") // "gpt-oss-120b"
 * extractShortModelName("gpt-oss-120b-20260205") // "gpt-oss-120b"
 * extractShortModelName("gpt-oss-120b-latest") // "gpt-oss-120b"
 */
