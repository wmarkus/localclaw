# 🦞 LocalClaw — Local-Only Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/openclaw/openclaw/main/docs/assets/openclaw-logo-text.png" alt="LocalClaw" width="500">
    </picture>
</p>
...
It is a **local-only**, **secure**, **sovereign-data** fork of OpenClaw — no cloud model providers, no remote model serving, and loopback-only inference.
Based on OpenClaw, originally created by Peter Steinberger and the community.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that is local-first, secure, and always-on, this is it.
...
Model note: the default setup assumes Ollama is running on `http://127.0.0.1:11434`. See [Onboarding](https://docs.openclaw.ai/start/onboarding).
...
Upgrading? [Updating guide](https://docs.openclaw.ai/install/updating) (and run `localclaw doctor`).
...
```bash
git clone https://github.com/wmarkus/localclaw.git
cd localclaw
...
Note: `pnpm localclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `localclaw` binary (alias: `openclaw`).
...
- **[Voice Wake](https://docs.openclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.openclaw.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with local system TTS.
...
- [Browser control](https://docs.openclaw.ai/tools/browser): dedicated LocalClaw-managed Chrome/Chromium, snapshots, actions, uploads, profiles.
...
- **[Browser control](https://docs.openclaw.ai/tools/browser)** — LocalClaw‑managed Chrome/Chromium with CDP control.
...
- Link the device: `pnpm localclaw channels login` (stores creds in `~/.openclaw/credentials`).
